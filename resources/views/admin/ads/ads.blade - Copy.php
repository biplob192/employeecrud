...
<div class="pd-20 card-box mb-30">
	<div style="width:57%; float: left;">
		<form action="" method="post">
			...
			<div class="form-row">
				<div class="col-6">
					<select class="form-control custom-select2" id="corr_id" name="" required>
				...
				<div class="col-3">
					<select class="form-control" id="payment_status" name="" required>
				...
				<div class="col-3" style="width: 30%;">
					<input class="form-control" type="button" id="search_btn" value="Search">
				</div>
			</div>
	...
	<div style="width:40%; float: right;">
		<form action="{{url('/ads')}}" method="GET">
		  <div class="form-row">
		    <div class="col-5">
		      <input class="form-control date-picker" type="text" name="from" placeholder="From">
		    </div>
		    <div class="col-5">
		      <input class="form-control date-picker" type="text" name="to" placeholder="To">
		    </div>
		    <div class="col">
