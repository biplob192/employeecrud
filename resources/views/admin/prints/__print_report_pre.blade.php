		...
		<div class="container-md">
			<div class="row align-items-center">
				...
				<div class="col align-self-center">
					<center><br>
						<a href="{{url('/print-report')}}" class="btnprn btn"><button class="btn btn-outline-dark">Print Preview</button></a>
					</center>
				...
				<div class="col table-responsive-md align-self-center">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr style="font-weight:bold; background:#ECECEC;">
								<td colspan="2">
									Total Paid Commission: {{$data['total_comm']}} Taka || Last Commission: {{$data['last_comm'] ? $data['last_comm']['commission_amount'] : '0'}} Taka - {{$data['last_comm'] ? $data['last_comm']['commission_date'] : ''}}
								</td>
								<td style="text-align: right; font-weight:bold;">Payable Commission Due:</td>
