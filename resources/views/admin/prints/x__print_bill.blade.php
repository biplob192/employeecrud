					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr style="height:200px; text-align: center;">
								...
								<td style="vertical-align: middle">0 </br> + Vat 15%</td>
								<td style="text-align: center; vertical-align: middle">{{$ad->amount}} <br>{{$vat = $ad->amount * 0.15}}</td>
							</tr>
								...
								<td style="text-align: center;">{{$total =  $ad->amount + $vat}}</td>
							</tr>
						</tbody>
					</table>
				</div>
