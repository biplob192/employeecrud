...
<div class="pd-20 card-box mb-30">
	<form action="cheque" method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-12 col-md-10">
				<input class="form-control" type="text" name="bank_name" value="{{old('bank_name')}}" placeholder="Bank Name">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-12 col-md-2 col-form-label">Cheque Amount</label>
			<div class="col-sm-12 col-md-10">
				<input class="form-control" type="text" name="cheque_amount" value="{{old('cheque_amount')}}" placeholder="Cheque Amount">
			</div>
		</div>
		<div class="form-group row">
